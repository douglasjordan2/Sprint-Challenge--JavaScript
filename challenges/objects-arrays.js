...
*/
const animalNames = [];
zooAnimals.forEach(n => {return animalNames.push(`Name: ${n.animal_name}, Scientific: ${n.scientific_name}.`)});
...
const lowerCase = zooAnimals.map(a => {return a.animal_name.toLowerCase()});
...
zooAnimals.filter(s => {if(s.population < 5) {return largerPopulation.push(s)}});
